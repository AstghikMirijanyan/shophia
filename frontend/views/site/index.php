...
?>
    <div class="content">
        ...
        <div class="slickslider">
            ...
            <div><img src="<?= \yii\helpers\Url::to('@web/images/sliderImages//49263811_681024278965824_3871820800101187584_n.jpg' )?>" alt="slider"></div>
        </div>
        <!--END SLIDER-->
        <div class="support">
            ...
            <div class="middle_support">
                <div class="right">
                    <div class="triangle triangle_right"><img src="<?= \yii\helpers\Url::to('@web/images/ball.png' )?>" alt=""></div>
                    <div class="terms center_terms">
        ...
        <div class="handPicked">
            ...
            <div class="middle_handPicked">
                ...
                <div class="title_handPicked"><h1>HandPicked</h1></div>
                <div class="rumba">
                    <img src="<?= \yii\helpers\Url::to('@web/images/rectangle.png' )?>" alt="">
                </div>
            </div>
            <div class="middle_handPicked"></div>
        </div>
        <!--COLLECTION-->
        <div class="collection">
            <div class="middle_collection">
                <div class="small_collection">
                    <div class="collection_one">

                    </div>
                </div>
                <div class="small_collection">
                    <div class="collection_two">
            ...
            <div class="middle_collection">
                ...
                <div class="small_collection">
                    <div class="collection_four">

                    </div>
                </div>
                <div class="small_collection">
                    <div class="collection_five">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="summer_collection">
            <div class="middle_summer_collection">
                <img src="<?= \yii\helpers\Url::to('@web/images/summer1.png' )?>" alt="">
            </div>
            <div class="middle_summer_collection">
                <img src="<?= \yii\helpers\Url::to('@web/images/summer2.png' )?>" alt="">
            </div>
            <div class="middle_summer_collection">
                <img src="<?= \yii\helpers\Url::to('@web/images/summer3.png' )?>" alt="">
            </div>
            <div class="middle_summer_collection">
